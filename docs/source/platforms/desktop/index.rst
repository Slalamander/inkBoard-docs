...
This functionality may come in a future version, but for now, if that icon in the taskbar bugs you, the :doc:`/integrations/systemtray` integration can be used to have inkBoard show in the system tray, rather than the taskbar.
