...
def my_print_function():
    ...
    This decorator wraps a function to catch a function call and removes the element and touch event, 
    provided those are the only two positional arguments.
    Aside from that, it also shows how to interface  with the inkBoard core,
